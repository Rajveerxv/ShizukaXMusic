    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("Youcanthurtme00")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("Youcanthurtme00")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Ronny_support_chats8")
                await self.five.join_chat("Youcanthurtme00")
            except:
                pass
            assistants.append(5)
